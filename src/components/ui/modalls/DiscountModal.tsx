      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-slate-200">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <textarea
              className="w-full border-2 border-slate-100 rounded-xl p-3 text-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none h-28 resize-none transition-all"
