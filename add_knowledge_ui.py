# Script para adicionar UI de Base de Conhecimento
# Execute: python add_knowledge_ui.py
...
# Encontrar linha 383 (</section> da Base de Conhecimento antiga)
# Substituir linhas 360-383 pelo novo código

new_section = '''            {/* CARD 2: BASE DE CONHECIMENTO */}
...
# Substituir linhas 360-383 (índices 359-382 no array)
new_lines = lines[:359] + [new_section] + lines[383:]

# Escrever de volta
with open(file_path, 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("✅ UI de Base de Conhecimento adicionada com sucesso!")
